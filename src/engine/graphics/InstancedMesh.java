...
//
//    public InstancedMesh(float[] positions, float[] textCoords, float[] colours, float[] normals, int[] indices, int numInstances) {
//        super(positions, textCoords, colours, normals, indices,  Mesh.createEmptyIntArray(Mesh.MAX_WEIGHTS * positions.length / 3, 0), Mesh.createEmptyFloatArray(Mesh.MAX_WEIGHTS * positions.length / 3, 0));
//
